export default {
  ...
  AERODROMS_ALERT: "\tУказывается четырехбуквенное обозначение аэродрома (посадочной площадки).\
        \n\tЕсли аэродром (посадочная площадка) не имеет четырехбуквенного обозначения, указывается ZZZZ и дополнительная информация - в поле 18 DEP/.\
        \n\tЕсли план полета подается с борта воздушного судна, указывается AFIL и дополнительная информация - в поле 18 DEP/.",
  FLY_RULE_ALERT: "\tПравила полета указываются одной из следующих латинских букв:\
  ...
  FLY_TYPE_ALERT: "\tТип полета обозначается одной из следующих букв:\
  ...
  TYPE_ALERT: "\tОбозначения типов воздушных судов содержатся в документе ИКАО 'Условные обозначения типов воздушных судов' (Doc 8643 ИКАО).\
  ...
  INDEX_ALERT: "\tВ поле 7 (Опознавательный индекс воздушного судна) задействуется не более семи буквенно-цифровых знакомест и указывается:\
  ...
  FLYTYPES_ARRAY: [
      {id: 0, name: 'S', code: 'S', description: 'по расписанию'},
      {id: 1, name: 'N', code: 'N', description: 'вне расписания'},
      {id: 2, name: 'G', code: 'G', description: 'для авиации общ. назн.'},
      {id: 3, name: 'M', code: 'M', description: 'гос. авиация'},
      {id: 4, name: 'X', code: 'X', description: 'экспер. авиация и пр.'}],
